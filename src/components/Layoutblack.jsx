  ...
  return (
   <nav className="w-full bg-noirpolariz pb-5 overflow-hidden relative">
      ...
      <div className="max-w-[75%] mx-auto flex flex-col md:flex-row items-center justify-between pt-6 px-4 md:py-3">
        ...
        <h1 className="font-clash text-3xl md:text-4xl font-semibold text-headers mb-4 md:mb-0 text-center">
          POLARIZ AGENCY
        </h1>
        ...
        <div className='flex flex-wrap justify-center md:flex-row items-center space-x-4 md:space-x-6 font-clash text-sm md:text-base'>
          <a href='/' className="text-headers cursor-pointer hover:opacity-70"> ACCUEIL</a>
          <a href='/Nos_projets' className="text-headers cursor-pointer hover:opacity-70"> PROJET </a>
          <a href='/Qui_sommes_nous' className="text-headers cursor-pointer hover:opacity-70"> À PROPOS </a>
          <a href='/Contact' className="text-headers cursor-pointer hover:opacity-70"> CONTACT </a>
        </div>
      </div>
