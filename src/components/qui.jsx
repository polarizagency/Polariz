...
function Qui() {
    return (
        <section className="w-full  py-20 px-4">
            ...
            <h2 className="ml-55 font-clash text-5xl md:text-8xl font-semibold text-noirpolariz uppercase leading-tight my-10">
                QUI SOMMES NOUS ?
            </h2>

            <div>
                <img src={GenstravailleIMG} className='max-w-5xl mx-20 mt-20' alt="personnes en réunion" />
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-15 font-manrope text-noirpolariz text-xl leading-relaxed max-w-4xl ml-auto my-20 mr-20'>
                    <p>
            ...
            <div className='m-20'>
                <img src={HommebureauIMG} className='max-w-4xl ml-auto' alt="homme à son bureau" />
                <div className='font-manrope text-noirpolariz text-xl leading-relaxed max-w-4xl ml-auto my-20'>
