...
function Pourquoi() {
  return (
   <section className="w-full  py-20 px-4">
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={animationverslehaut} className="max-w-[75%] mx-auto flex flex-col items-start justify-start">
    ...
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={animationverslehaut} className="max-w-[75%] mx-auto flex flex-col items-end justify-end mt-20">
    ...
    <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={animationverslehaut} className="max-w-[75%] mx-auto flex flex-col items-start justify-start mt-20">
